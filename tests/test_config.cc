...
sylar::ConfigVar<std::map<std::string, int>>::ptr g_str_int_map_value_config = 
		sylar::Config::Lookup("system.str_int_map", std::map<std::string, int>{{"k", 2}, {"k2", 1}}, "system str int map");
sylar::ConfigVar<std::unordered_map<std::string, int>>::ptr g_str_int_umap_value_config = 
		sylar::Config::Lookup("system.str_int_umap", std::unordered_map<std::string, int>{{"k", 2}, {"k2", 1}}, "system str int umap");
...
void test_yaml()
{
	YAML::Node root = YAML::LoadFile("/home/pengpeng/windows_shared/sylar/bin/conf/test.yml");
...
#define XX_M(g_val, name, prefix) \
	...
	XX(g_int_vec_value_config, int_vac, before);
	...
	XX(g_int_vec_value_config, int_vac, after);
...
sylar::ConfigVar<std::map<std::string, Person>>::ptr g_person_map = 
		sylar::Config::Lookup("class.map", std::map<std::string, Person>{{"p1", Person()}}, "system Person");
