...
bool Socket::bind(const Address::ptr addr)
{
	...
	if(::bind(m_sock, addr->getAddr(), addr->getAddrLen()))
		{
 			SYLAR_LOG_ERROR(g_logger) << "bind error errno=" << errno << " errnostr" << strerror(errno);
			return false;
		}
